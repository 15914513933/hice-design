...
<html class="no-js" lang="">
    <head>
        ...
        <style>
                    <#if designWebsite.workBg??>
                        .work-bg {
                            background: rgba(0, 0, 0, 0) url(/upload/img${designWebsite.workBg!}) repeat scroll center center / cover;
                        }
                    </#if>
                </style>
    </head>
    <body>
        ...
        <!-- basic-slider start -->
        <div class="basic-slider <#if designWebsite.workBg??>work-bg<#else>slide-9</#if> height-100-vh">
            <div class="container">
		...
		<div class="basic-portfolio-area ptb-50">
			<div class="container">
				...
				<div class="view-more mt-20 text-center">
					<a class="btn btn-large" href="#">更多</a>
				</div>			
			</div>
		</div>
